...
const checkName = async topicName => {
  const nameExists = await TopicModel.findOne({
    name: topicName
  });
  if (nameExists) {
    return true;
...
const createNewTopic = async requestData => {
  try {
    let cookies = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..d3F3AxmAAh_yzJuvBh5_2SwlNeMmQdU8f9phQScKYn8";
