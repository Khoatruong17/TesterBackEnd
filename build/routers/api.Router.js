...
const initApiRouter = app => {
  ...
  routerAPI.get("/commentforC/read", commentController.getCommentsForCoordinator);

  // contribution router
  routerAPI.post("/contribution/create", contributionController.createContribution); // get contribution by faculty_id
  routerAPI.get("/contribution/readbyfaculty", contributionController.showcontributionbyFaculty); // get contribution for Faculty
  routerAPI.get("/contribution/readforGuest", contributionController.showcontributionForGuest); // get all contribution
  routerAPI.get("/contribution/read", contributionController.getAllContribution); // get all contribution
  routerAPI.delete("/contribution/delete/:id", contributionController.delContribution); // delete

  routerAPI.get("/contribution/download/:id", contributionController.downloadContribution); // download contribution by id
