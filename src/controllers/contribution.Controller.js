...
const contributionController = {
  ...
  updateContribution: async (req, res) => {
    try {
      ...
      const updateContribution = await Contributions.findByIdAndUpdate(
        req.params.id,
        {
          name: updatedContributionName,
          description: updatedContributionDescription,
          submit_date: updatedContributionDate,
        },
        { new: true }
      );
